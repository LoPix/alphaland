...
STR_R3F_LOG_action_heliporter = "Lift the objet";
STR_R3F_LOG_action_heliporter_fait = "Objet ""%1"" attached.";
STR_R3F_LOG_action_heliport_larguer = "Drop the objet";
STR_R3F_LOG_action_heliport_larguer_fait = "Objet ""%1"" dropped.";
