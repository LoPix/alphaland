...
[] spawn
{
	...
	while {true} do
	{
		uisleep 5;
			...
			parseText
			format["			
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.5'  shadowColor='#000000' image='custom\statusbar\icons\players.paa' color='%9'/> %2</t>
				...
				<t shadow='1' shadowColor='#000000' color='%9'><img size='0.9'  shadowColor='#000000' image='custom\statusbar\icons\poptab.paa' color='%9'/> %4</t>
				<t shadow='1' shadowColor='#000000' color='%15'><img size='1.1'  shadowColor='#000000' image='custom\statusbar\icons\thermostat.paa' color='%9'/> %18%20</t>
				<t shadow='1' shadowColor='#000000' color='%16'><img size='1.0'  shadowColor='#000000' image='custom\statusbar\icons\thermo.paa' color='%9'/> %19%20</t>
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.0'  shadowColor='#000000' image='custom\statusbar\icons\exile.paa' color='%9'/> %8</t>
				<t shadow='1' shadowColor='#000000' color='%9'><img size='1.5'  shadowColor='#000000' image='custom\statusbar\icons\restart.paa' color='%9'/>%12:%13</t>",				
						"%",
						count playableUnits,
						_damage,
						_wallet,
