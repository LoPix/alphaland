...
if (count _availChems == 0) then {["ErrorTitleAndText", ["Whoops", "No chemlights..."]] call ExileClient_gui_toaster_addTemplateToast;} else
{
	...
	*/
	...
	["SuccessTitleAndText",["Success", "Chemlight On!"]] call ExileClient_gui_toaster_addTemplateToast;
	//hint "Chemlight On!";
	sleep 2;
	hint "";	
	/*
	...
	*/
	...
	_extinguish = player addAction ["Extinguish Chemlight","ExAdClient\XM8\Apps\AttachChemApp\extinguishLight.sqf",_chemLight,0,false];
