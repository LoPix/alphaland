...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat+ IL_Supported_Motorboat + IL_Supported_SDV + IL_Supported_Lada + IL_Supported_Volha + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Octavius + IL_Supported_UAZ + IL_Supported_TowTractor + IL_Supported_OldTractor +  IL_Supported_Tractor + IL_Supported_LandRoverAmbulance + IL_Supported_LandRover + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_WATERSCOOTER + IL_Supported_MB4WD + IL_Supported_RHIB + IL_Supported_GOLF + IL_Supported_SUVXL + IL_Supported_SUV;
	...
	IL_Supported_Cargo_Veh_URAL_COVERED = IL_Supported_Cargo_Veh_Offroad + IL_Supported_Rubberboat + IL_Supported_RHIB + IL_Supported_SDV + IL_Supported_Lada + IL_Supported_Volha + IL_Supported_Octavius + IL_Supported_UAZ + IL_Supported_TowTractor + IL_Supported_OldTractor;
	...
	IL_Supported_Cargo_Veh_TEMPEST = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_BTR40 + IL_Supported_HMMWV + IL_Supported_PROWLER + IL_Supported_QILIN;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat + IL_Supported_SDV  + IL_Supported_WATERSCOOTER  + IL_Supported_SUV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_Lada + IL_Supported_Volha + IL_Supported_Octavius + IL_Supported_Motorboat + IL_Supported_TowTractor + IL_Supported_RHIB + IL_Supported_GOLF + IL_Supported_Strider;
	...
	IL_Supported_Cargo_Mohawk = IL_Supported_Cargo_Veh_Mohawk;
	...
	IL_Supported_Cargo_CHINOOK = IL_Supported_Cargo_Veh_CHINOOK;
	...
	IL_Supported_Cargo_Veh_BLACKFISH = IL_Supported_Cargo_Veh_Mohawk + IL_Supported_QILIN + IL_Supported_UAZ + IL_Supported_OFFROAD + IL_Supported_MB4WD + IL_Supported_SUVXL + IL_Supported_PROWLER + IL_Supported_HEMTT + IL_Supported_KAMAZ + IL_Supported_TEMPEST + IL_Supported_Ikarus + IL_Supported_URAL + IL_Supported_V3S + IL_Supported_BRDM2;
	//IL_Supported_Cargo_NonVeh_BLACKFISH = IL_Supported_Cargo_NonVeh_Mohawk;
	IL_Supported_Cargo_BLACKFISH = IL_Supported_Cargo_Veh_BLACKFISH;
	
	IL_Supported_Cargo_Veh_Y32 = IL_Supported_Cargo_Veh_Mohawk;
	//IL_Supported_Cargo_NonVeh_Y32 = IL_Supported_Cargo_NonVeh_Mohawk;
	IL_Supported_Cargo_Y32 = IL_Supported_Cargo_Veh_Y32;

	IL_Supported_Cargo_Veh_HURON = IL_Supported_Cargo_Veh_Mohawk + IL_Supported_QILIN + IL_Supported_UAZ + IL_Supported_OFFROAD + IL_Supported_MB4WD + IL_Supported_SUVXL + IL_Supported_PROWLER;
	//IL_Supported_Cargo_NonVeh_HURON = IL_Supported_Cargo_NonVeh_Mohawk;
	IL_Supported_Cargo_HURON = IL_Supported_Cargo_Veh_HURON;
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_Ikarus) then
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["cargo_offset", 4.2, true];
		};		
		...
		if (_obj_type in IL_Supported_SUVXL) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 2.4, true];
		};		
		...
		{
			{
                ...
                {					
					if (_lock2 <= 1) then
                    {
                        ...
                        ["SuccessTitleAndText", format ["%1 successfully loaded!",_IL_noti]] call ExileClient_gui_toaster_addTemplateToast;
						[Player, IL_Load_Score] call IL_Score;
						};
					}
                    else
                    {
                    ["ErrorTitleAndText", ["Whoops", "Locked vehicles can't be loaded!"]] call ExileClient_gui_toaster_addTemplateToast;
                    };
				}
                else
				{
                ["ErrorTitleAndText", ["Whoops", "Locked vehicles can't load Cargo!"]] call ExileClient_gui_toaster_addTemplateToast;
				};
...
if (_obj_main_type in IL_Supported_Vehicles_HUNTER) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo on HUNTER</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from HUNTER</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_IFRIT) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo on IFRIT</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from IFRIT</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_STRIDER) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo on STRIDER</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">Unload cargo from STRIDER</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_LANDROVER) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on LANDROVER</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on LANDROVER</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from LANDROVER</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_AMBULANCE) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on AMBULANCE</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on AMBULANCE</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from AMBULANCE</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_O_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
